      ...
      <div className="max-w-[1024px] w-full  bg-on-primary">
        ...
        <main className="lg:px-0 px-5 " id="page-wrap">
            ...
            <div className="flex flex-col-reverse md:flex-row items-center">
              ...
              <div className="flex flex-col items-center md:items-start mb-10 self-center md:ml-10 py-2 grow">
                ...
                <div className="mb-4 max-w-sm font-normal lg:text-lg md:text-left text-center text-base text-on-primary-container">
                  ...
                  attach your transfer transactions your work details such as
                  work title, description, deliverable and so on. Then, your
                  works are visualized as colorful voxels. You can easily share
                  your colorful voxels as your CV.
                </div>
          ...
          <div className="flex overflow-scroll" ref={membersDiv}>
            <MemberCard name="Kantaro Fujimori" roles={["Co-founder", "CDO"]}>
              Co-founder and CDO (chief Design Officer) of VESS. Ex-job is an
              embedded engineer of Roland Company.
            </MemberCard>
            <MemberCard name="Kouki Minamoto" roles={["Co-founder", "CDO"]}>
              Co-founder and CDO (chief Design Officer) of VESS. Ex-job is an
              embedded engineer of Roland Company.
            </MemberCard>
            <MemberCard name="Kelivn Au" roles={["Co-founder", "CDO"]}>
              Co-founder and CDO (chief Design Officer) of VESS. Ex-job is an
              embedded engineer of Roland Company.
            </MemberCard>
            <MemberCard name="Ibuki Nakajima" roles={["Co-founder", "CDO"]}>
              Co-founder and CDO (chief Design Officer) of VESS. Ex-job is an
              embedded engineer of Roland Company.
            </MemberCard>
          </div>
